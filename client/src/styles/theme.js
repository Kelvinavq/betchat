export const colors = {
  ...
  glass: {
    ...
    text:        'rgba(var(--bc-admin-accent-rgb, 80, 160, 255), 0.40)',
    textInput:   'rgba(var(--bc-admin-accent-rgb, 80, 160, 255), 0.42)',
    textSubtle:  'rgba(var(--bc-admin-accent-rgb, 80, 160, 255), 0.38)',
    textTitle:   'rgba(var(--bc-admin-accent-rgb, 80, 160, 255), 0.45)',
...
export const gradients = {
  ...
  loginBg:   'radial-gradient(ellipse at center, var(--bc-admin-sidebar-bg, #080818) 0%, var(--bc-admin-content-bg, #000000) 100%)',
  card:      'linear-gradient(160deg, rgba(var(--bc-admin-accent-rgb, 30, 133, 255), 0.14) 0%, rgba(0, 0, 0, 0.72) 100%)',
}
...
export const shadows = {
  ...
  glassFocus:  '0 0 0 2px var(--bc-admin-accent, #1e85ff), 0 0 24px rgba(var(--bc-admin-accent-rgb, 30, 133, 255), 0.22)',
  glassCard:   'inset 0 1px 0 rgba(var(--bc-admin-accent-rgb, 80, 170, 255), 0.09), 0 48px 96px -24px rgba(0, 0, 0, 0.80)',
  glassBubble: 'inset 0 1px 0 rgba(var(--bc-admin-accent-rgb, 80, 170, 255), 0.09), 0 8px 32px -4px rgba(0, 0, 0, 0.60)',
}
