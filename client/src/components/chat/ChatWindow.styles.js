...
export const VisualSection = styled.div`
  ...
  height: 128px;
  background: var(--bc-client-body-bg, #000000);
  border-bottom: 1px solid rgba(var(--bc-client-accent-rgb, 30, 133, 255), 0.12);
  display: flex;
  flex-direction: column;
  align-items: center;
...
export const CloseBtn = styled.button`
  ...
  height: 34px;
  border-radius: 50%;
  background: var(--bc-client-surface, rgba(255, 255, 255, 0.07));
  border: 1px solid var(--bc-client-border, rgba(255, 255, 255, 0.10));
  display: flex;
  align-items: center;
  justify-content: center;
  cursor: pointer;
  color: var(--bc-client-text-2, rgba(255, 255, 255, 0.65));
  transition: background 0.2s;
  svg { font-size: 17px; }
  &:hover { background: var(--bc-client-surface2, rgba(255, 255, 255, 0.13)); }
`
...
export const VisualLogo = styled.div`
  ...
  height: 54px;
  border-radius: 50%;
  background: var(--bc-client-accent, #1e85ff);
  border: 1px solid rgba(var(--bc-client-accent-rgb, 40, 140, 255), 0.30);
  box-shadow: 0 0 26px rgba(var(--bc-client-accent-rgb, 30, 133, 255), 0.35), ${shadows.glassBubble};
  display: flex;
  align-items: center;
  justify-content: center;
  overflow: hidden;
...
export const AppLabel = styled.span`
  ...
  color: var(--bc-client-text-2, rgba(255, 255, 255, 0.72));
`
...
export const FormHint = styled.p`
  font-size: 11.5px;
  color: var(--bc-client-text-2, rgba(255, 255, 255, 0.35));
  margin: -3px 0 0;
`
...
export const InputLabel = styled.label`
  ...
  color: var(--bc-client-text-muted, rgba(255, 255, 255, 0.40));
...
export const StyledInput = styled.input`
  ...
  height: 44px;
  padding: 0 14px;
  background: var(--bc-client-surface, rgba(255, 255, 255, 0.05));
  border: 1px solid var(--bc-client-border, rgba(255, 255, 255, 0.08));
  border-radius: 10px;
  color: var(--bc-client-text, #ffffff);
  font-size: 16px;
  font-family: inherit;
  ...
  &::placeholder { color: var(--bc-client-text-muted, rgba(255, 255, 255, 0.18)); }
  &:focus {
...
export const CountrySelect = styled.select`
  ...
  option { background: var(--bc-client-surface, #1a1a2e); color: var(--bc-client-text, #fff); }
`
...
export const PasswordToggle = styled.button`
  ...
  background: none;
  border: none;
  color: var(--bc-client-text-muted, rgba(255, 255, 255, 0.30));
  cursor: pointer;
  display: flex;
  align-items: center;
  padding: 4px;
  ...
  svg { font-size: 18px; }
  &:hover { color: var(--bc-client-text-2, rgba(255, 255, 255, 0.60)); }
`
...
export const SupportSep = styled.span`
  font-size: 11px;
  color: var(--bc-client-text-muted, rgba(255,255,255,0.15));
  user-select: none;
  pointer-events: none;
`
...
export const SupportPill = styled.button`
  ...
  cursor: pointer;
  text-decoration: none;
  color: var(--bc-client-text-2, rgba(255,255,255,0.36));
...
export const SupportList = styled.div`
  border-radius: 12px;
  overflow: hidden;
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.07));
`
...
export const SupportItem = styled.button`
  ...
  padding: 0 14px;
  height: 42px;
  background: var(--bc-client-surface, rgba(255,255,255,0.035));
  border: none;
  border-top: 1px solid var(--bc-client-border, rgba(255,255,255,0.05));
  font-family: inherit;
  font-size: 12.5px;
  font-weight: 400;
  color: var(--bc-client-text-2, rgba(255,255,255,0.58));
  cursor: pointer;
  text-decoration: none;
  text-align: left;
  transition: background 0.15s, color 0.15s;
  &:first-child { border-top: none; }
  &:hover { background: var(--bc-client-surface2, rgba(255,255,255,0.065)); color: var(--bc-client-text, rgba(255,255,255,0.82)); }
...
export const HelpCard = styled.div`
  width: min(360px, 100%);
  border-radius: 18px;
  background: var(--bc-client-surface, rgba(13, 13, 28, 0.96));
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.10));
...
export const HelpSub = styled.p`
  ...
  font-size: 12px;
  line-height: 1.35;
  color: var(--bc-client-text-2, rgba(255,255,255,0.42));
`
...
export const HelpClose = styled.button`
  ...
  align-items: center;
  justify-content: center;
  background: var(--bc-client-surface2, rgba(255,255,255,0.07));
  color: var(--bc-client-text-2, rgba(255,255,255,0.55));
  cursor: pointer;
  svg { font-size: 17px; }
`
...
export const HelpOption = styled.button`
  width: 100%;
  border: 1px solid ${({ $active }) => $active ? 'rgba(var(--bc-client-accent-rgb, 70,170,255),0.45)' : 'var(--bc-client-border, rgba(255,255,255,0.08))'};
  border-radius: 13px;
  padding: 12px 13px;
  background: ${({ $active }) => $active ? 'rgba(var(--bc-client-accent-rgb, 70,170,255),0.14)' : 'var(--bc-client-surface, rgba(255,255,255,0.04))'};
  color: var(--bc-client-text, rgba(255,255,255,0.82));
  text-align: left;
  font-size: 13px;
  font-weight: 700;
  cursor: pointer;
...
export const HelpTextarea = styled.textarea`
  ...
  min-height: 92px;
  resize: vertical;
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.09));
  border-radius: 13px;
  padding: 12px;
  margin-top: 10px;
  background: var(--bc-client-surface, rgba(255,255,255,0.05));
  ...
  font-family: inherit;
  outline: none;
  &::placeholder { color: var(--bc-client-text-muted, rgba(255,255,255,0.24)); }
`
...
export const HelpBtn = styled.button`
  ...
  border-radius: 999px;
  padding: 10px 15px;
  background: ${({ $primary }) => $primary ? 'var(--bc-client-button-bg, #0d4fe8)' : 'rgba(255,255,255,0.08)'};
  color: ${({ $primary }) => $primary ? 'var(--bc-client-button-text, #fff)' : 'var(--bc-client-text, #fff)'};
  font-size: 13px;
  font-weight: 800;
  cursor: pointer;
...
export const ActionBtn = styled.button`
  ...
  cursor: pointer;
  margin-top: 8px;
  box-shadow: 0 4px 18px rgba(var(--bc-client-accent-rgb, 30,133,255), 0.38);
  transition: opacity 0.2s, transform 0.15s, box-shadow 0.2s;
  &:hover { opacity: 0.88; box-shadow: 0 6px 24px rgba(var(--bc-client-accent-rgb, 30,133,255), 0.52); }
...
export const OrDivider = styled.div`
  ...
  color: var(--bc-client-text-muted, rgba(255, 255, 255, 0.25));
  &::before, &::after {
    content: '';
    flex: 1;
    height: 1px;
    background: var(--bc-client-border, rgba(255, 255, 255, 0.07));
  }
`
...
export const SocialBtn = styled.button`
  ...
  &:hover {
    background: var(--bc-client-surface2, rgba(255, 255, 255, 0.09));
    border-color: var(--bc-client-border, rgba(255, 255, 255, 0.18));
  }
`
...
export const HeaderBalanceBtn = styled.button`
  ...
  svg { font-size: 10px; }
  &:hover:not(:disabled) { opacity: 0.68; }
...
export const LogoutNoticeCard = styled.div`
  ...
  border-radius: 24px;
  background: var(--bc-client-surface, #111124);
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.10));
  box-shadow:
    0 0 0 1px rgba(var(--bc-client-accent-rgb, 40,140,255), 0.08),
...
export const LogoutNoticeIcon = styled.div`
  ...
  margin-bottom: 16px;
  color: var(--bc-client-on-accent, #ffffff);
  background: var(--bc-client-button-gradient, var(--bc-client-accent, #0d4fe8));
  border: none;
  box-shadow: 0 4px 24px rgba(var(--bc-client-accent-rgb, 30,133,255), 0.35);
...
export const MessagesArea = styled.div`
  ...
  &::before {
    top: 0;
    background: linear-gradient(to bottom, var(--bc-client-body-bg, #000000), transparent);
  }

  &::after {
    bottom: 0;
    background: linear-gradient(to top, var(--bc-client-body-bg, #000000), transparent);
  }
`
...
export const ChatMessages = styled.div`
  ...
  &::-webkit-scrollbar-thumb {
    background: var(--bc-client-border, rgba(255,255,255,0.10));
    border-radius: 2px;
  }
`
...
export const LoadEarlierBtn = styled.button`
  ...
  padding: 6px 14px;
  border-radius: 16px;
  background: var(--bc-client-surface, rgba(255,255,255,0.06));
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.09));
  color: var(--bc-client-text-2, rgba(255,255,255,0.56));
  font-size: 11px;
  font-weight: 600;
  font-family: inherit;
  cursor: pointer;
...
export const ReplyQuote = styled.div`
  ...
  margin-bottom: 6px;
  border-radius: 10px;
  border-left: 3px solid ${({ $received }) => $received ? 'var(--bc-client-accent, #46aaff)' : 'var(--bc-client-border, rgba(255,255,255,0.74))'};
  background: ${({ $received }) => $received ? 'rgba(var(--bc-client-accent-rgb, 30, 133, 255), 0.12)' : 'var(--bc-client-surface, rgba(255,255,255,0.16))'};
  color: var(--bc-client-text, rgba(255,255,255,0.78));
  overflow: hidden;
`
...
export const ReplyAuthor = styled.div`
  font-size: 10px;
  font-weight: 800;
  color: ${({ $received }) => $received ? 'var(--bc-client-accent, #46aaff)' : 'var(--bc-client-text, rgba(255,255,255,0.86))'};
  margin-bottom: 2px;
`
...
export const MessageBubble = styled.div`
  ...
  ${({ $received }) => $received ? css`
    ...
    border: 1px solid var(--bc-client-border, rgba(255,255,255,0.06));
...
export const MessageTime = styled.span`
  font-size: 10px;
  color: var(--bc-client-text-muted, rgba(255,255,255,0.26));
  padding: 0 3px;
`
...
export const VoicePlayBtn = styled.button`
  ...
  ${({ $received }) => $received ? css`
    background: var(--bc-client-button-bg, #0d4fe8);
    color: #ffffff;
  ` : css`
...
export const TypingText = styled.span`
  margin-left: 4px;
  color: var(--bc-client-text-muted, rgba(255,255,255,0.48));
  font-size: 11px;
  font-weight: 600;
  white-space: nowrap;
`
...
export const TypingDot = styled.span`
  ...
  height: 5px;
  border-radius: 50%;
  background: var(--bc-client-accent, rgba(96,165,250,0.88));
...
export const BotOptionBtn = styled.button`
  ...
  align-items: center;
  justify-content: center;
  transition: opacity 0.18s ease, transform 0.14s ease, box-shadow 0.20s ease, background 0.18s ease;

  /* Upload = primary CTA — solid accent gradient */
  ${({ $isUpload }) => $isUpload && css`
    background: var(--bc-client-bubble-bg, var(--bc-client-button-gradient, var(--bc-client-accent, #128C7E)));
    border: 1px solid rgba(0, 0, 0, 0.14);
    color: var(--bc-client-bubble-text, var(--bc-client-on-accent, #111111));
  ...
  /* Back = ghost with accent border + accent text */
  ${({ $isBack, $isUpload }) => $isBack && !$isUpload && css`
    background: rgba(0, 0, 0, 0.16);
    border: 1px solid rgba(255, 255, 255, 0.08);
    color: var(--bc-client-bubble-text, var(--bc-client-text, #ffffff));
    font-weight: 700;
    box-shadow: none;
    &:hover:not(:disabled) {
  ...
  /* Default = solid accent — visible on all themes including light (WhatsApp) */
  ${({ $isBack, $isUpload }) => !$isBack && !$isUpload && css`
    background: var(--bc-client-bubble-bg, var(--bc-client-accent, #128C7E));
    border: 1px solid rgba(0, 0, 0, 0.12);
    color: var(--bc-client-bubble-text, var(--bc-client-on-accent, #111111));
  ...
  &:disabled { opacity: 0.38; cursor: wait; pointer-events: none; transform: none; }
`
...
export const BotFormCard = styled.form`
  ...
  border-radius: 16px;
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.08));
  background: var(--bc-client-surface, rgba(255,255,255,0.055));
  color: var(--bc-client-text, rgba(255,255,255,0.88));
`
...
export const BotFormLoadingText = styled.span`
  font-size: 11.5px;
  font-weight: 600;
  color: var(--bc-client-text-2, rgba(255,255,255,0.52));
  letter-spacing: 0.04em;
`
...
export const BotFormTitle = styled.div`
  font-size: 13px;
  font-weight: 700;
  color: var(--bc-client-text, rgba(255,255,255,0.92));
`

export const BotFormDesc = styled.div`
  font-size: 12px;
  line-height: 1.45;
  color: var(--bc-client-text-2, rgba(255,255,255,0.54));
`
...
export const BotFormPasteBtn = styled.button`
  ...
  border-radius: 10px;
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.10));
  background: var(--bc-client-surface2, rgba(255,255,255,0.06));
  color: var(--bc-client-text-2, rgba(255,255,255,0.72));
  font-size: 11px;
  cursor: pointer;
  transition: background 0.18s, color 0.18s;
  &:hover { background: var(--bc-client-surface, rgba(255,255,255,0.10)); }
`
...
export const BotFormSubmit = styled.button`
  ...
  border: none;
  border-radius: 10px;
  background: var(--bc-client-bubble-bg, var(--bc-client-accent, #facc15));
  color: var(--bc-client-bubble-text, #111111);
  font-weight: 700;
  font-family: inherit;
  font-size: 13px;
  cursor: pointer;
...
export const BankDetailLabel = styled.div`
  ...
  text-transform: uppercase;
  letter-spacing: 0.05em;
  color: var(--bc-client-text-muted, rgba(255,255,255,0.38));
  margin-bottom: 2px;
`
...
export const BankDetailValue = styled.div`
  ...
  word-break: break-word;
  font-weight: 600;
  ${({ $mono }) => $mono ? 'font-family: "JetBrains Mono", "SFMono-Regular", Consolas, monospace; font-weight: 500;' : ''}
`

export const BankCopyBtn = styled.button`
  flex-shrink: 0;
  height: 30px;
  border: 1px solid rgba(var(--bc-client-accent-rgb, 96,165,250), 0.22);
  background: rgba(var(--bc-client-accent-rgb, 96,165,250), 0.10);
  color: var(--bc-client-accent, #60a5fa);
  border-radius: 999px;
  padding: 0 12px;
  display: inline-flex;
  ...
  svg { font-size: 13px; }
  &:hover {
    background: rgba(var(--bc-client-accent-rgb, 96,165,250), 0.18);
...
export const BotFormSelect = styled.select`
  ...
  option { background: var(--bc-client-surface, #1a1a2e); color: var(--bc-client-text, #ffffff); }
`
...
export const AttachPanel = styled.div`
  ...
  right: 0;
  height: 200px;
  background: var(--bc-client-surface, rgba(8,8,20,0.96));
  backdrop-filter: blur(24px) saturate(160%);
  -webkit-backdrop-filter: blur(24px) saturate(160%);
  border-top: 1px solid var(--bc-client-border, rgba(255,255,255,0.08));
...
export const AttachOption = styled.button`
  ...
  gap: 8px;
  height: 80px;
  background: var(--bc-client-surface2, rgba(255,255,255,0.05));
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.08));
  border-radius: 14px;
  cursor: pointer;
  color: var(--bc-client-text-2, rgba(255,255,255,0.65));
  ...
  svg { font-size: 22px; color: var(--bc-client-accent, #46aaff); }

  &:hover {
    background: rgba(var(--bc-client-accent-rgb, 30,133,255), 0.10);
    border-color: rgba(var(--bc-client-accent-rgb, 30,133,255), 0.22);
    color: var(--bc-client-text, rgba(255,255,255,0.90));
  }
`
...
export const ChatFooter = styled.div`
  ...
  background: var(--bc-client-body-bg, #0b0b18);
  border-top: 1px solid var(--bc-client-border, rgba(255,255,255,0.06));
`
...
export const ReplyComposer = styled.div`
  ...
  border-radius: 14px;
  background: var(--bc-client-bubble-bg, #facc15);
  border: 1px solid rgba(0, 0, 0, 0.10);
  border-left: 3px solid var(--bc-client-bubble-bg, var(--bc-client-accent, #46aaff));
`
...
export const ReplyComposerBody = styled.div`
  margin-top: 1px;
  font-size: 12px;
  color: color-mix(in srgb, var(--bc-client-bubble-text, #111111) 78%, transparent);
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
`
...
export const ReplyComposerClose = styled.button`
  ...
  svg { font-size: 15px; }
  &:hover { background: rgba(17,17,17,0.14); color: #111111; }
`
...
export const PlusBtn = styled.button`
  ...
  justify-content: center;
  cursor: pointer;
  transition: background 0.2s, border-color 0.2s, color 0.2s, opacity 0.2s, transform 0.25s;
  transform: ${({ $isActive }) => $isActive ? 'rotate(45deg)' : 'rotate(0deg)'};

  background: ${({ $isActive }) =>
    $isActive ? 'rgba(var(--bc-client-accent-rgb, 30, 133, 255), 0.18)' : 'rgba(var(--bc-client-accent-rgb, 255,255,255), 0.06)'};
  border: 1px solid ${({ $isActive }) =>
    $isActive ? 'rgba(var(--bc-client-accent-rgb, 30, 133, 255), 0.35)' : 'var(--bc-client-border, rgba(255,255,255,0.09))'};
  color: ${({ $isActive }) =>
    $isActive ? 'var(--bc-client-accent, #1e85ff)' : 'var(--bc-client-text-2, rgba(255,255,255,0.50))'};
...
export const ChatInput = styled.input`
  ...
  outline: none;
  transition: border-color 0.2s, box-shadow 0.2s;
  &::placeholder { color: var(--bc-client-text-muted, rgba(255,255,255,0.22)); }
  &:focus {
    border-color: var(--bc-client-accent, #1e85ff);
    box-shadow: 0 0 0 3px rgba(var(--bc-client-accent-rgb, 30,133,255), 0.13);
  }
`
...
export const SendBtn = styled.button`
  ...
  background: var(--bc-client-accent, #1e85ff);
  box-shadow: 0 3px 12px rgba(var(--bc-client-accent-rgb, 30,133,255), 0.40);
  svg { color: #ffffff; font-size: 16px; }

  &:hover:not(:disabled) { opacity: 0.85; box-shadow: 0 5px 16px rgba(var(--bc-client-accent-rgb, 30,133,255), 0.55); }
  &:active:not(:disabled) { transform: scale(0.93); }

  &:disabled {
    background: var(--bc-client-border, rgba(255,255,255,0.08));
    box-shadow: none;
    cursor: default;
    opacity: 0.45;
  }
...
export const MediaMsgPdf = styled.div`
  ...
  &:hover { background: var(--bc-client-surface2, rgba(255, 255, 255, 0.11)); }
`
...
export const ViewerFileName = styled.p`
  font-size: 12px;
  color: var(--bc-client-text-2, rgba(255, 255, 255, 0.38));
  letter-spacing: 0.04em;
  text-align: center;
  word-break: break-all;
  max-width: 320px;
...
export const ViewerImg = styled.img`
  ...
  object-fit: contain;
  border-radius: 16px;
  box-shadow: 0 20px 80px rgba(0, 0, 0, 0.80), 0 0 0 1px var(--bc-client-border, rgba(255, 255, 255, 0.06));
`
...
export const ViewerEmbed = styled.iframe`
  ...
  border-radius: 12px;
  border: 1px solid var(--bc-client-border, rgba(255, 255, 255, 0.10));
  background: var(--bc-client-surface, rgba(255, 255, 255, 0.02));
`
...
export const ViewerBtn = styled.button`
  ...
  ${({ $download }) => $download ? css`
    background: var(--bc-client-button-bg, #0d4fe8);
    border: none;
    color: var(--bc-client-button-text, #ffffff);
    box-shadow: 0 4px 18px rgba(13, 79, 232, 0.42);
  ` : css`
    background: var(--bc-client-surface, rgba(255, 255, 255, 0.08));
    border: 1px solid var(--bc-client-border, rgba(255, 255, 255, 0.14));
    color: var(--bc-client-text-2, rgba(255, 255, 255, 0.68));
  `}
...
export const DepositAlertBtn = styled.button`
  ...
  border-radius: 23px;
  border: none;
  background: rgb(var(--alert-rgb, 0, 210, 110));
  color: var(--bc-client-button-text, #ffffff);
  font-size: 15px;
  font-weight: 700;
  font-family: inherit;
...
export const ReceiptDetailCard = styled.div`
  ...
  background: var(--bc-client-surface, rgba(12,18,28,0.98));
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.08));
  border-bottom: none;
  display: flex;
  flex-direction: column;
...
export const ReceiptDetailHeader = styled.div`
  ...
  border-bottom: 1px solid var(--bc-client-border, rgba(255,255,255,0.06));
  flex-shrink: 0;
`
...
export const ReceiptDetailClose = styled.button`
  ...
  border-radius: 50%;
  border: none;
  background: var(--bc-client-surface2, rgba(255,255,255,0.08));
  color: var(--bc-client-text-2, rgba(255,255,255,0.55));
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  flex-shrink: 0;
  svg { font-size: 16px; }
  &:hover { background: var(--bc-client-border, rgba(255,255,255,0.14)); }
`
...
export const ReceiptDetailPreview = styled.div`
  ...
  border-radius: 12px;
  overflow: hidden;
  background: var(--bc-client-surface2, rgba(255,255,255,0.04));
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.07));
  display: flex;
  align-items: center;
  justify-content: center;
...
export const ReceiptDetailPdfPreview = styled.div`
  ...
  svg { font-size: 28px; color: var(--bc-client-text-muted, rgba(255,255,255,0.35)); }
  span { font-size: 13px; color: var(--bc-client-text-2, rgba(255,255,255,0.55)); }
  &:hover { opacity: 0.85; }
`
...
export const ReceiptDetailStatusBadge = styled.div`
  ...
  font-size: 13px;
  font-weight: 600;
  background: ${({ $bg }) => $bg || 'var(--bc-client-surface2, rgba(255,255,255,0.07))'};
  color: ${({ $color }) => $color || 'var(--bc-client-text-2, rgba(255,255,255,0.6))'};
  border: 1px solid ${({ $color }) => $color ? `${$color}33` : 'var(--bc-client-border, rgba(255,255,255,0.10))'};
  svg { font-size: 15px; }
`
...
export const ReceiptDetailRows = styled.div`
  ...
  gap: 0;
  border-radius: 12px;
  background: var(--bc-client-surface2, rgba(255,255,255,0.03));
  border: 1px solid var(--bc-client-border, rgba(255,255,255,0.06));
  overflow: hidden;
`
...
export const ReceiptDetailRow = styled.div`
  ...
  &:not(:last-child) {
    border-bottom: 1px solid var(--bc-client-border, rgba(255,255,255,0.05));
  }
`
