...
CREATE TABLE IF NOT EXISTS `hgcash_movements` (
  ...
  `hg_movement_id`        VARCHAR(255)    DEFAULT NULL,
  `gateway_movement_id`   VARCHAR(255)    DEFAULT NULL,
  `hg_account_id`         VARCHAR(255)    DEFAULT NULL,
  `provider_event_id`     VARCHAR(255)    DEFAULT NULL,
  `gateway_event_id`      VARCHAR(255)    DEFAULT NULL,
  `destination_domain`    VARCHAR(255)    DEFAULT NULL,
  ...
  `from_cbu`              VARCHAR(50)     DEFAULT NULL,
  `to_cbu`                VARCHAR(50)     DEFAULT NULL,
  `from_cuit`             VARCHAR(30)     DEFAULT NULL,
  `to_cuit`               VARCHAR(30)     DEFAULT NULL,
  ...
  `received_from_gateway_at` DATETIME      DEFAULT NULL,
  `updated_from_gateway_at`  DATETIME      DEFAULT NULL,
  `created_at`            DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at`            DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_hgc_provider_status` (`provider_status`),
  KEY `idx_hgc_bank_status` (`bank_status`),
  KEY `idx_hgc_provider_event_id` (`provider_event_id`),
  KEY `idx_hgc_gateway_event_id` (`gateway_event_id`),
  KEY `idx_hgc_account_id` (`account_id`),
